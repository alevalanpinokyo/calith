                    ...
                    <div class="p-6 cursor-pointer flex items-center justify-between select-none" onclick="toggleDayAccordion(${i})">
                        ...
                        <div class="flex items-center gap-3 shrink-0 relative z-20">
                            ...
                            <button onclick="event.stopPropagation(); startWorkoutMode('${p.id}', ${i})" 
                                    class="w-10 h-10 rounded-xl bg-calith-orange/10 border border-calith-orange/20 flex items-center justify-center hover:bg-calith-orange group/play transition-all shadow-lg shadow-calith-orange/5"
                                    title="Antrenmanı Hemen Başlat">
                                <i data-lucide="play" class="w-4 h-4 text-calith-orange group-hover/play:text-black fill-current group-hover/play:fill-black"></i>
                            </button>
                            <!-- Chevron -->
