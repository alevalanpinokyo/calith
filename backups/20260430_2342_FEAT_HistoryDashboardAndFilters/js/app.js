...
function renderHistoryDashboard(logs) {
    ...
    container.innerHTML = `
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="bg-white/5 border border-white/5 rounded-2xl p-5 hover:border-calith-orange/20 transition-all">
                <span class="block text-[9px] font-black text-gray-500 uppercase tracking-widest mb-2">TOPLAM HACİM</span>
                <div class="flex items-end gap-2">
                    <span class="text-2xl font-black text-white">${(totalVolume / 1000).toFixed(1)}t</span>
                    <span class="text-[10px] font-bold text-calith-orange mb-1">TON</span>
                </div>
            </div>
            <div class="bg-white/5 border border-white/5 rounded-2xl p-5 hover:border-calith-orange/20 transition-all">
...
async function copyBulkReport() {
    ...
    logs.forEach(log => {
        ...
        text += `⏱️ Süre: ${log.duration || '00:00'} | Hacim: ${calculateWorkoutVolume(log)}kg\n`;
